 ...
 *
 */
double BoundedVector::getMagnitude() { return std::sqrt(x * x + y * y); }
/**
 *
 */
 ...
 *
 */
BoundedVector BoundedVector::operator-() { return BoundedVector(-x, -y); }
/**
 *
 */
 ...
 *
 */
std::string BoundedVector::asDebugString() const { return asString(); }
} // namespace Model
/**
 *
 */
