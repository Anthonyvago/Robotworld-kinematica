...
public:
   ...
   *
   */
  void setActiveFilters(const std::vector<eFilterType> &activeFilters);
  /**
   *
   */
  void addFilter(eFilterType newFilter);
  /**
   *
   */
  void removeFilter(eFilterType newFilter);
  /**
   *
   */
   ...
   *
   */
  bool isCommunicating() const { return communicating; }
  /**
   *
   */
  PathAlgorithm::OpenSet getOpenSet() const { return astar.getOpenSet(); }
  /**
   *
   */
  PathAlgorithm::Path getPath() const { return path; }
  /**
   *
   */
   ...
   *
   */
  BoundedVector getFront() const { return front; }
...
private:
   ...
   *
   */
  void activateFilterVisualization(eFilterType filter, bool activate);
