...
public:
   ...
   *
   */
  LineShape(RectangleShapePtr aNode1, RectangleShapePtr aNode2,
            const std::string &aTitle = "", int aLineWidth = 1,
            int anArrowHeadSize = 10);
  /**
   *
   */
  LineShape(Model::ModelObjectPtr aModelObject, RectangleShapePtr aNode1,
            RectangleShapePtr aNode2, const std::string &aTitle = "",
  ...
  void setNode1(RectangleShapePtr aNode1) { node1 = aNode1; }
  void setNode2(RectangleShapePtr aNode2) { node2 = aNode2; }

protected:
  RectangleShapePtr getNode1() { return node1; }
  const RectangleShapePtr getNode1() const { return node1; }

  RectangleShapePtr getNode2() { return node2; }
  const RectangleShapePtr getNode2() const { return node2; }
