...
struct ShapeData {
   ...
   */
  virtual std::string asString() const { return "ShapeData"; }
  /**
   * Returns a description of the object with all data of the object usable for
   * debugging
   */
  virtual std::string asDebugString() const { return asString(); }
  //@}
};
//	struct ShapeData
...
public:
  ...
  explicit Shape(Model::ModelObjectPtr aModelObject)
      : ViewObject(aModelObject), data(nullptr), selected(false) {
   ...
   *
   */
  ShapeData *getData() const { return data; }
  /**
   *
   */
   ...
   *
   */
  void setSelected(bool aSelected = true) { selected = aSelected; }
  /**
   ...
   *
   */
  virtual Point getSelectedPoint() const { return getCentre(); }
  //@}
  /**
   * This function is called by the RobotWorldCanvas if enableActivation is set
   * for the RobotWorldCanvas. If this is not the desired behaviour override
   * RobotWorldCanvas::handleItemActivated in a derived class.
   */
  virtual void handleActivated() {}
  /**
   * This function is called by the RobotWorldCanvas if enableSelection is set
   * for the RobotWorldCanvas. If this is not the desired behaviour override
   * RobotWorldCanvas::handleSelectionChanged in a derived class.
   */
  virtual void handleSelection() {}
  /**
   * This function is called by the RobotWorldCanvas when the user starts
   * dragging this object.
   */
  virtual void handleBeginLeftDrag() {}
  /**
   * This function is called by the RobotWorldCanvas when the user drops this
   * object after dragging.
   */
  ...
  virtual std::string asString() const {
    return "Shape " + getObjectId().asString() +
