...
/**
 * @see
 * http://http://docs.wxwidgets.org/stable/defs_8h#a11f6efc0e8d8d680f3ec8e82aa4f1770
 */
...
enum GeometryCentre { CENTRE = wxCENTRE, CENTER = CENTRE };
...
std::string GetTextFromUser(const std::string &aTitleBarMessage,
                            ...
                            Window *aParent = nullptr, bool centre = false,
