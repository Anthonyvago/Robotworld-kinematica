...
public:
   ...
   *
   */
  PathPtr newPath(const std::string &aName = "New Path",
                  const wxColour &pathColor = wxColour(0, 0, 0),
                  const wxColour &positionColor = wxColour(0, 0, 0),
                  bool aNotifyObservers = false);
  /**
   *
   */
   ...
   *
   */
  void populate(const std::vector<eFilterType> &activeFilters,
